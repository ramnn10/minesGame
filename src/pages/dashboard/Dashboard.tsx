        ...
        <>
            <div className="flex items-center justify-center min-h-screen bg-black w-full">
                <div className="w-full max-w-[960px] mx-auto p-1 bg-[#1a202c]">
                    <div className="w-full bg-gradient-to-b from-[#0435a1] to-[#0a6ed1] border-2 border-[#FB9C23] rounded-xl shadow-xl text-white font-medium sm:w-full md:w-[90%] lg:w-[80%] xl:w-full mx-auto">
                                ...
                                <div className="md:w-[35%] mx-auto">
                                    ...
                                    <div className='my-1.5 flex justify-between items-center bg-[#024495] rounded-xl px-1'>
                                        ...
                                        <div>
                                            ...
                                            <select
                                                id="mine-count"
                                                className="w-24 p-[3px] rounded-[20px] text-white text-[15px] bg-gray-700 border-gray-600"
                                                value={mineCount}
                                        ...
                                        <div className='flex flex-col md:flex-row md:gap-1 justify-start items-center space-x-2 md:space-y-0 space-y-1 m-1 px-4 rounded-[20px] bg-[#0267A5] py-1 relative' >
                                            ...
                                            <div className='flex justify-end items-center gap-1'>
                                                <button id="bet-decrease"
                                                    onClick={decreaseBet}
                                                    disabled={betAmount <= MIN_BET || gameActive}
                                                    className="w-7 h-7 flex items-center justify-center rounded-full shadow-md shadow-[#fff1cd33] bg-[#0267a5] border-[1px] border-black/50 text-white font-bold text-xl hover:bg-[#02578c] transition-colors disabled:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed">-</button>
                                                <div
                                                    onClick={() => handleBetButtons()}
                                                    className="w-7 h-7 cursor-pointer flex items-center justify-center rounded-full shadow-md shadow-[#fff1cd33] bg-[#0267a5] border-[1px] border-black/50 text-white font-bold text-xl hover:bg-[#02578c] transition-colors">
                                            ...
                                            <div className='absolute -top-[325px] left-0'>
                                                <BetsButtonModal
                                                    isOpen={isBetButton}
